...
Version  : 2023.2
Release  : 20
URL      : https://www.x.org/archive/individual/proto/xorgproto-2023.2.tar.gz
Source0  : https://www.x.org/archive/individual/proto/xorgproto-2023.2.tar.gz
Source1  : https://www.x.org/archive/individual/proto/xorgproto-2023.2.tar.gz.sig
...
%prep
%setup -q -n xorgproto-2023.2
cd %{_builddir}/xorgproto-2023.2
pushd ..
cp -a xorgproto-2023.2 build32
popd
pushd ..
cp -a xorgproto-2023.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691082483
